...
open class CurrentWeatherDataAPI {
    ...
    open class func currentWeatherData(q: String? = nil, id: String? = nil, lat: String? = nil, lon: String? = nil, zip: String? = nil, units: Units_currentWeatherData? = nil, lang: Lang_currentWeatherData? = nil, mode: Mode_currentWeatherData? = nil, completion: @escaping ((_ data: Model200?,_ error: Error?) -> Void)) {
        currentWeatherDataWithRequestBuilder(q: q, id: id, lat: lat, lon: lon, zip: zip, units: units, lang: lang, mode: mode).execute { (response, error) -> Void in
     ...
     */
    open class func currentWeatherDataWithRequestBuilder(q: String? = nil, id: String? = nil, lat: String? = nil, lon: String? = nil, zip: String? = nil, units: Units_currentWeatherData? = nil, lang: Lang_currentWeatherData? = nil, mode: Mode_currentWeatherData? = nil) -> RequestBuilder<Model200> {
        let path = "/weather"
        ...
        let requestBuilder: RequestBuilder<Model200>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
